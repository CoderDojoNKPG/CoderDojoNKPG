<template>
	<header>
		...
		<a href="http://coderdojonkpg.se/index.html"><img src="img/icon/logowithtext.png" id="logo"/></a>
		<input type="checkbox" id="toggleMenu" onchange="updateMenuVisible()" value="Visa meny" />
